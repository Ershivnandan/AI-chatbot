  ...
  useEffect(() => {
    if (showError) {
      const timer = setTimeout(() => {
        setShowError(false)
        setTimeout(() => setError(null), 300) // Allow fade out animation
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">Your multilingual companion</p>
              </div>
            </div>
                  ...
                  {languages.map((lang) => (
                    ...
                    >
                      <span className="flex items-center space-x-2">
                        ...
                        <span className="text-gray-400 text-sm">({lang.label})</span>
                      </span>
                    </SelectItem>
                  ))}
                </SelectContent>
              ...
              {messages.length === 0 ? (
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-gray-400">
                    Choose your preferred language and let's chat! I'm here to listen, help, and be your companion.
                  </p>
                </div>
              ) : null}
            </CardTitle>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="h-[60vh] overflow-y-auto space-y-4 pr-2">
              {messages.length === 0 && (
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-400 mb-4">Start a conversation with your AI friend!</p>
                    ...
                    <Button
                      ...
                      onClick={() => {
                        ...
                        if (input) {
                          ...
                          handleInputChange({ target: { value: "Hello! How are you today?" } } as any)
                    ...
                    <Button
                      ...
                      onClick={() => {
                        ...
                        if (input) {
                          ...
                          handleInputChange({ target: { value: "Tell me a joke!" } } as any)
                          form?.dispatchEvent(event)
                        }
                      }}
                    >
            ...
            <form onSubmit={onSubmit} className="flex space-x-2">
              <Input
                ...
                placeholder={`Type your message in ${languages.find((l) => l.value === selectedLanguage)?.native}...`}
